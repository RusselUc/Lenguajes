...
{		
	...
	public void analizadorLexico(String token) 
	{
		...
		String cadenas[] = {"Market", "Run", "private", "while","Krill","boolean","{","}", "=", ";","<", ">",   //12... Aunque no se usa como tal el "!" solo, sirve para que no lance error
		...
		if(tipo==-1) {
			Pattern pat = Pattern.compile("^[aA-zZ]+[0-9]+$");
